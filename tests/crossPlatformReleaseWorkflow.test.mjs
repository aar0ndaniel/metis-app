...
assert.match(workflow, /install\.packages\(c\("seminr", "semPower"\)[\s\S]*dependencies = TRUE/, 'Workflow should install CRAN packages missing from the base conda environment with dependencies.')
