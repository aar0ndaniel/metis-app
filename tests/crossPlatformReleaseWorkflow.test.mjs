...
assert.match(workflow, /conda create[\s\S]*abseil-cpp[\s\S]*udunits2/, 'Workflow should include native libraries needed by CRAN packages that compile against Abseil and UDUNITS.')
