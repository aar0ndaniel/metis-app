...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  runIsolatedModerationR2: (payload: any) => ipcRenderer.invoke('plumber:runIsolatedModerationR2', payload),
  ...
  extractDataset: (payload: string | { workspacePath: string; datasetId?: string }) => ipcRenderer.invoke('workspace:extractDataset', payload),
